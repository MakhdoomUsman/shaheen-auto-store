  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid capitalize grid-cols-5 gap-4 justify-center items-center">
          {/* <div className=" col-span-2 justify-self-end text-right space-y-2"> */}
          <p className="col-span-2 justify-self-end">Unique Identifier :</p>
          <p className="col-span-3">{transactionRef?.unique_identifier}</p>
          <p className="col-span-2 justify-self-end">Invoice # :</p>
          <p className="col-span-3">{transactionRef?.invoice?.invoice_ref}</p>
          <p className="col-span-2 justify-self-end">Transaction # :</p>
          <p className="col-span-3">{transactionRef?.trxnumber}</p>
          <p className="col-span-2 justify-self-end">Payment Status :</p>
          <p
            className={`${
            ...
            } table-td col-span-3 inline-block max-w-max py-1 px-3 min-w-[90px] text-center  rounded-full bg-opacity-25`}
          >
            {transactionRef?.payment_status}
          </p>
          <p className="col-span-2 justify-self-end">Payment Verification :</p>
          <p
            className={`${
          ...
          <p className="col-span-3">{transactionRef?.fiat_amount} USD</p>
          <p className="col-span-2 justify-self-end">Crypto Amount :</p>
          ...
          {transactionRef?.transection_hash && (
            <>
              <p className="col-span-2 justify-self-end">Transaction Hash :</p>
              <p
                onClick={() =>
                ...
                className="col-span-3 border p-1 rounded cursor-pointer w-96 max-h-20 bg-black-200 overflow-y-auto break-words"
              >
                {transactionRef?.transection_hash}
              </p>
            </>
          ...
          {transactionRef?.blockchain_link_with_transection_hash && (
            <>
              <p className="col-span-2 justify-self-end">Blockchain Link :</p>
              <p
                onClick={() =>
                  navigator.clipboard.writeText(
                    transactionRef?.blockchain_link_with_transection_hash
                ...
                className="col-span-3 border lowercase p-1 rounded cursor-pointer w-96 max-h-20 bg-black-200 overflow-y-auto break-words"
              >
                {transactionRef?.blockchain_link_with_transection_hash}
              </p>
            </>
          ...
          {transactionRef?.failed_return_url && (
            <>
              <p className="col-span-2 justify-self-end">Fail Return Url :</p>
              <p className="col-span-3">
          ...
          <p className="col-span-2 justify-self-end">Payment Url :</p>
          <p className="col-span-3 lowercase text-blue-600">
            <a
              href={
                baseUrl +
                "/payment/" +
