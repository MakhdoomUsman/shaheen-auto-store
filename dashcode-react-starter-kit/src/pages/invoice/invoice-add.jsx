        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="col-span-full mt-5">
              <div className="flex justify-between items-center gap-5 py-4 px-6 bg-slate-50 dark:bg-slate-800 border dark:border-slate-700 border-slate-200">
              ...
              {editBlock ? (
                ...
                <div className="col-span-full mt-4 mx-6">
                  {isEdit ? (
      ...
      </Card>
      {
        ...
        >
          ...
          <div className="w-full mx-auto">
            ...
            <hr></hr>
            <div className="font-bold text-center ">OYF.io</div>
