            ...
            <Tab.Panel>
              ...
              <Card bodyClass="p-0">
                <div className="flex justify-between flex-wrap space-y-4 px-6 pt-6 bg-slate-50 dark:bg-slate-800 pb-6 rounded-t-md">
                  ...
                  <div className="space-y-[2px]">
                    <span className="block text-slate-900 dark:text-slate-300 font-medium leading-5 text-xl mb-4">
                      <div className="text-slate-600 font-medium mt-5 dark:text-slate-300 text-xs uppercase">
                        {invoiceDetails?.payment_status === "success" ? (
                          <h1 className="block  font-large font-bold   underline decoration-dotted text-green-500">
                            Paid
                          </h1>
                        ) : invoiceDetails?.payment_status === "pending" ? (
                          <h1 className="block font-large font-bold  underline decoration-dotted text-red-500">
                            Unpaid
                          </h1>
                        ) : (
                          invoiceDetails?.payment_status === "refund" && (
                            <h1 className="block font-large font-bold  underline decoration-dotted text-primary-500">
                              Refund
                            </h1>
                          )
                        )}
