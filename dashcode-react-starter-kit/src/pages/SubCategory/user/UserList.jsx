...
import { getSingleUser, getSubCategory } from "../store/actions";
...
const UserList = ({ title = "Manage Sub-Category" }) => {
  ...
  const fetchUsers = async (query) => {
    ...
    await getSubCategory(query).then((users) => {
